...
const GOLDEN_RICHMOND_NODES: &[(&str, f64, f64, f64)] = &[
    ...
    ("1", 43200.0, 172.9209715351487, 0.0),
    ("1", 86400.0, 70.32146275162522, 0.0),
    ("219", 0.0, 187.24677896061854, 0.0),
    ("219", 43200.0, 190.07048721575296, 0.0),
    ("219", 86400.0, 186.62175949503072, 0.0),
    ("440", 0.0, 217.00846692626945, 0.0),
    ("440", 43200.0, 216.63117914501123, 0.0),
    ("440", 86400.0, 216.92298651800436, 0.0),
    ("660", 0.0, 260.47355885498513, 0.0),
    ("660", 43200.0, 259.96042145568157, 0.0),
    ("660", 86400.0, 260.1555820569106, 0.0),
    ("F", 0.0, 237.67000000000002, 0.0),
    ("F", 43200.0, 237.58942243937642, 0.0),
    ("F", 86400.0, 237.60494927797194, 0.0),
];
const GOLDEN_RICHMOND_LINKS: &[(&str, f64, f64)] = &[
    ("785", 0.0, 0.015214678137398345),
    ("785", 43200.0, 0.027733577224923832),
    ("785", 86400.0, 0.015214874850548354),
    ("1047", 0.0, 0.00013284217055210574),
    ("1047", 43200.0, 0.0001619414397750103),
    ("1047", 86400.0, 0.0001328421055013107),
    ("1337", 0.0, 0.0),
    ("1337", 43200.0, -1.1874166785928642e-9),
    ("1337", 86400.0, 3.5194807938117967e-9),
    ("1601", 0.0, -5.263700586510823e-8),
    ("1601", 43200.0, -8.233661919026871e-12),
    ("1601", 86400.0, 1.0942818069953628e-8),
    ("v1708", 0.0, 9.225422199256496e-5),
    ("v1708", 43200.0, 0.00019655142873142598),
    ("v1708", 86400.0, 9.227626471795914e-5),
];
const GOLDEN_RICHMOND_SUMS: (f64, f64) = (179792.18407915116, 1.5442684300735035);
