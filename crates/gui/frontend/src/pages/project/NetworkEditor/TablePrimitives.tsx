// The water-distribution editor's table *cells*: inputs that hold a staged
// draft, mark it, and can have it discarded. That machinery belongs to an
// editor with a Save button, which is why it stayed here when the row
// metrics, the sort header and the virtualisation moved to
// `components/panels/editorTable` — those are what any table of elements
// needs, editable or not.
